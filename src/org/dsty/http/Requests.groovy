/* groovylint-disable DuplicateStringLiteral, Instanceof, ThrowException, UnnecessaryGetter, UnnecessarySetter */
 ...
 *def response = Requests.get('https://httpbin.org/get', params: queryParams)
 *{@literal /}{@literal /} would create the following url
 * https://httpbin.org/get?key1=value1&key2=value2&key2=value3}</pre>
 ...
 *{@literal /}{@literal /} would create the
 * following url https://httpbin.org/get?key1=hello%20world}</pre>
 *
 * <p>Headers:
 * <pre>{@code
